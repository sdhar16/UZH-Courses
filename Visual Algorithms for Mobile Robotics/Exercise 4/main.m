...
for img_idx = 1:2
    ...
    gaussian_blur = gaussian_scale_blur(image, num_scales, num_octaves, sigma);
    
    DoG = differenceOfgaussian(gaussian_blur, num_octaves, num_scales);
    nms = nonmaxsup(DoG, num_octaves, num_scales, contrast_threshold);
